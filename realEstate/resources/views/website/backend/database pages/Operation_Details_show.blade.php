            ...
            <div class="modal-body">
                <form id="EditOpDetailForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"  style="border-radius: 3pt" pattern="[A-Z][a-z]+(\s*([A-Z][a-z]+)*)*" title="First Letter must be Capital"  name="operation_det" id="operation_det" class="form-control" required>
                    </div>
