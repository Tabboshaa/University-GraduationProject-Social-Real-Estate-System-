        ...
        <div class="x_panel">
            ...
            <form method="POST" action="{{ url('/add_main_type') }}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                        <input id="Main Type Name" pattern="(^([A-Z][a-z]+)?$)" title="First Letter must br Capital"  style="border-radius: 3pt" type="text" class="form-control @error('Main_Type_Name') is-invalid @enderror" name="Main_Type_Name" value="{{ old('Main_Type_Name') }}" required autocomplete="Main_Type_Name" autofocus>
                ...
                <div class="form-group row mb-0">
                    <div class="col-md-2 offset-md-2">
                        ...
                        <button id="btun2"  class="btn btn-primary">
                            <a href="{{url('/main_types_show')}}" class="link2" >{{ __('Show') }}</a>
                        </button>
                    </div>
                </div>
            </form>
