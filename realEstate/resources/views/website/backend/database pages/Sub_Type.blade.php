        ...
        <div class="x_panel">
            ...
            <form method="POST" action="{{ url('/add_sub_type') }}" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                        <input id="Sub Type Name"  style="border-radius: 3pt" pattern="[A-Z][a-z]+(\s*([A-Z][a-z]+)*)*" title="First Letter must be Capital"  type="text" class="form-control @error('Sub_Type_Name') is-invalid @enderror" name="Sub_Type_Name" value="{{ old('Sub Type Name') }}" required  autocomplete="Sub Type Name" autofocus>
