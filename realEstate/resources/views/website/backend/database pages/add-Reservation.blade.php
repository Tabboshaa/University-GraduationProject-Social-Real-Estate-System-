...
<table id="datatable" class="table table-bordered dataTable no-footer" style="width: 100%;" role="grid" aria-describedby="datatable_info">
    <thead>
        <tr>
        <th><h2 style="margin-right:90px; padding-bottom: 5px;">Operation Id</h2></th>
                        <th ><h2 style="margin-right:90px;padding-bottom: 5px;">Card Number</h2></th>
                        <th ><h2 style="margin-right:90px;padding-bottom: 5px;">Paid Amount</h2></th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Card Number</h5>
            ...
            <div class="modal-body">
                <form id="EditCountryForm">
                    ...
                    <div class="form-group">
                        <label for="CountryName" style="font-size: 12pt">Card Number</label>
                        <input type="text" style="border-radius: 3pt" name="Card_Num" id="Card_Num" class="form-control">
                    </div>
...
<script>
    ...
    function setCardName(id, Number) {
