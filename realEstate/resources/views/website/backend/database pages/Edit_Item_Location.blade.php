...
$.ajax({
    ...
    success: function(data) {
        ...
        FormTag.find('#StreetName').html(" ");
        FormTag.find('#StreetName').html(opppp);
    },
    error: function() {
        //  console.log('error');
    }
...
<div class="right_col" role="main">
    <div class="title_right">
        ...
        @include('website.backend.layouts.flashmessage')
            <form method="POST" action="{{ url('/edit_item_location2/'.$item_id) }}" enctype="multipart/form-data">
            ...
            @csrf
                ...
                <!-- Add State-->
                <div class="form-group row">
                    <label for="State_Name" class="col-md-2 col-form-label text-md-right" style="font-size: 12pt">
                        {{ __('State :') }}
                    </label>
                ...
                <!-- Add City-->
                <div class="form-group row">
                    <label for="City_Name" class="col-md-2 col-form-label text-md-right" style="font-size: 12pt">
                        {{ __('City :') }}
                    </label>
                ...
                <!-- Add Region-->
                <div class="form-group row">
                    <label for="Region_Name" class="col-md-2 col-form-label text-md-right" style="font-size: 12pt">
                        {{ __('Region :') }}
                    </label>
                ...
                <!-- Add New Street -->
                <div class="form-group row">
                    <label for="Street_Name" class="col-md-2 col-form-label text-md-right" style="font-size: 12pt">
                        {{ __('Street :') }}
                    </label>

                    <div class="col-md-2">
                        <select id="StreetName" style="border-radius: 3pt"  class="form-control @error('Stree Name') is-invalid @enderror" name="Street_Name" value="{{ old('Street Name') }}" required autocomplete="Region Name">
